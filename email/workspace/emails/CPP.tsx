                ...
                <Container style={mainBodyContainer}>
                    <Section>
                        <Row style={logoBanner}>
                            ...
                            <Column style={right}>
                                <Img
                                    style={{ ...logoBannerImg, paddingLeft: "20px" }}
                                    src={imperialLogoURL}
                                    alt="imperial logo"
                                />
                            </Column>
                    ...
                    <Container style={textBodyContainer}>
                        ...
                        <Section>
                            <Text style={text}>
                                If you did not send this email you can safely ignore it.
                            </Text>
                        </Section>
                        ...
                        <Section>
                            <Text style={footerText}>
                                Magic link sent by Imperial’s CPP Connect
                                {company ? ` to ${company}` : ""}.<br />
                                CPP Connect will never ask you for a password or your personal
                                information.
                            </Text>
                            <Text style={footerText}>
