 ...
 */
export const getDefaultMailer = () => new Mailer(
 ...
 */
export const defaultMailer = (to: EmailString[], subject: string, html: string, mailer: Mailer): Promise<void> => mailer.sendMail(
